...
<html>
    ...
    <body>
        ...
        <div id="hospInfo">
        	<label>병원명 : </label><div class="hospVal" id="hospName"></div><br>
        	<label>주소 : </label><div class="hospVal" id="hospAddr"></div><br>
        	<label>전화번호 : </label><div class="hospVal" id="hospTel"></div><br>
        	<label>홈페이지  : </label><div class="hospVal" id="hospUrl"></div><br>
        </div>
