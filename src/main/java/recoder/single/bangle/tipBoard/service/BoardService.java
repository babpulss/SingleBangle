...
public class BoardService {
	...
	@Transactional("tx")
	public int tipBoardWrite(String realPath, BoardDTO dtoB, FileDTO dtoF) throws Exception{
		//추후 리턴할 결과
		int writeResult=0;
	...
	public BoardDTO getDto(int seq) throws Exception{
		BoardDTO dto = boardDao.getDto(seq);
		System.out.println("getDto 수행한 결과 값: "+dto);
		return dto;
	}

	@Transactional("tx")
	public int updateTip(String realPath, BoardDTO dtoB, FileDTO dtoF) throws Exception{
		int updateResult = 0;
	...
	public int likeCheck(int seq, String id) throws Exception{
		int likeCheckResult  = boardDao.likeCheck(seq, id);
	...
	public int likeInsert(int seq, String id) throws Exception{
		int likeInsertResult = boardDao.likeInsert(seq, id);
	...
	public int likeDelete(int seq, String id)  throws Exception{
		int likeDeleteResult = boardDao.likeDelete(seq, id);
	...
	public int scrapCount(int seq) throws Exception {
		int scrapCount = boardDao.scrapCount(seq);
		return scrapCount;
	}

	public List<ScrapDTO> myScrap(String id, int currentPage) throws Exception{
		List<ScrapDTO> myScrapList = boardDao.myScrap(id, currentPage);
		return myScrapList;
	}

	public String getNavi(int currentPage)  throws Exception{
		// currentPage = 현재 페이지 번호
		int recordTotalCount = boardDao.tipCount();	 // recordTotalCount : 전체 게시물 개수
	...
	public String getSearchNaviTitle(int currentPage, String searchInput, String tipCategory) throws Exception { 
		// currentPage = 현재 페이지 번호
		int recordTotalCount = boardDao.searchTitleCount(searchInput); // recordTotalCount : 전체 게시물 개수
	...
	public String getSearchNaviContents(int currentPage, String searchInput, String tipCategory)  throws Exception{ 
		// currentPage = 현재 페이지 번호
	...
	public String getSearchNaviBoth(int currentPage, String searchInput, String tipCategory) throws Exception { 
		// currentPage = 현재 페이지 번호
		int recordTotalCount = 0; // recordTotalCount : 전체 게시물 개수
	...
	public String getCmtNavi(int currentPage, int seq) throws Exception { 
	...
	public List<CommentDTO> selectByPageCmt(int currentPage, int seq) throws Exception{
	...
	public List<BoardDTO> selectByPageTitle(int currentPage, String input) throws Exception{
	...
	public List<BoardDTO> selectByPageContents(int currentPage, String input) throws Exception{
	...
	public List<BoardDTO> selectByPageBoth(int currentPage, String input) throws Exception{
	...
	public int deleteTip(int seq)  throws Exception{
		int deleteResult = boardDao.deleteTip(seq);
		return deleteResult;
	}
